            ...
            <View style={styles.infor}>
                ...
                <TextInputMask
                    ...
                    onChangeText={(formatted, extracted) => {
                        // +1 (123) 456-78-90
                        setPrice(Number(extracted)) // 1234567890
                    }}
                    mask={"$[0],[000],[000]"}
                ...
                <TextInputMask
                    ...
                    keyboardType='number-pad'
                    value={inventory}
                    onChangeText={(formatted, extracted) => setInventory(Number(extracted))}
                    mask={"[000]"}
                    style={styles.inputMask}
                ></TextInputMask>
                ...
                <Input
                    inputStyle={{backgroundColor:'yellow', alignContent:'flex-start',alignItems:'flex-start',justifyContent:'flex-start' , fontSize: 17, paddingHorizontal: 0, alignSelf: 'flex-start', }}
